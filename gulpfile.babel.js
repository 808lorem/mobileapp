...
// СОЗДАТЬ @IMPORT SCSS/SASS ИЗ ПАПКИ BLOCKS
gulp.task('sass:lib', () => {
...
gulp.task('sprite:png', function() {
	let mask = 'src/common/img/png-sprite/*.png';
...
gulp.task('sprite:svg', function () {
	let mask = 'src/common/img/svg-sprite/*.svg';
...
gulp.task('move', () => {
	...
	gulp.src('dist/img/sprite.{png,svg}')
...
gulp.task('imgmin', () => {
	return gulp.src(['dist/img/**/*', '!dist/img/sprite.svg'])
